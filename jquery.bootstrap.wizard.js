    ...
    var bootstrapWizardCreate = function (element, options) {
        ...
        this.fixNavigationButtons = function () {
            ...
            if (obj.firstIndex() >= obj.currentIndex()) {
                ...
                $($settings.previousSelector, element).addClass('disabled').attr('disabled','').mouseout();
            } else {
                //$('li.previous', element).removeClass('disabled');
                $($settings.previousSelector, element).removeClass('disabled').removeAttr('disabled');
            }

            if (obj.currentIndex() >= obj.navigationLength()) {
                //$('li.next', element).addClass('disabled');
                $($settings.nextSelector, element).addClass('disabled').attr('disabled', '').mouseout();
            } else {
                //$('li.next', element).removeClass('disabled');
                $($settings.nextSelector, element).removeClass('disabled').removeAttr('disabled');
            }
